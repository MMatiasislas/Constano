...
import { deleteRoutineDay } from "@/app/(dashboard)/dashboard/alumnos/[id]/rutinas/actions";
...
export function EliminarDiaDialog({
  day,
  memberId,
}: {
  day: RoutineDay;
  ...
  async function handleDelete() {
    setLoading(true);
    const result = await deleteRoutineDay(day.id, day.routine_id, memberId);
    setLoading(false);
